            ...
            <div id="content">
                ...
                <div class="card-body text-center">
                    <table class="table table-bordered table-striped">
                        ...
                        <?php
                                $no = 1;
                                $tampil = mysqli_query($connect, "SELECT * from user order by id desc");
                            ...
                            <tr>
                                ...
                                <td><?=$data['level']?></td>
                                <td>
                                    <a href="adm-tambah-user.php?hal=edit&id=<?=$data['id']?>" class="btn btn-warning"> Edit </a>
                                    <a href="adm-tambah-user.php?hal=hapus&id=<?=$data['id']?>" 
